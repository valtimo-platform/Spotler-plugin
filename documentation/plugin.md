...
This is a Spotler Plugin demonstrating an API call action. It fetches data from a time API endpoint.
...
```kotlin
dependencies {
    implementation("com.ritense.valtimoplugins:spotler:0.0.1")
}
```
